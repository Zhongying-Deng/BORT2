            ...
            if self.dist_net and self.training:
                ...
                for _ in range(sample_num):
                    ...
                    for ind in range(f.shape[0]):
                        ...
                        noise = noise.to(scale_diag.device)
...
class FixMatchMSCMDistNetMetaLearnRetrain(FixMatch):
    ...
    def __init__(self, cfg):
        ...
        if 'DomainNet' in cfg.DATASET.NAME:
            self.weight_ent = 0.001
        else:
            self.weight_ent = 0.1
    ...
    def forward_backward(self, batch_x, batch_u):
        ...
        if hyper_step and self.finetune:
            ...
            print('hyper-optimization step: loss_val {}'.format(entropy_val.item()))
            self.model.eval()
