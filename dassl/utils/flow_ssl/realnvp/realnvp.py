...
from .coupling_layer import MaskCheckerboard
from .coupling_layer import MaskChannelwise
...
class RealNVP(RealNVPBase):
    ...
    def __init__(self, num_scales=2, in_channels=3, mid_channels=64, num_blocks=8, input_img=True):
        ...
        for scale in range(num_scales):
            if input_img:
                ...
                in_couplings = self._threecouplinglayers(in_channels, mid_channels, num_blocks, MaskChannelwise)
            ...
            if scale == num_scales - 1:
                if input_img:
                    ...
                    layers.append(passThrough(
                        CouplingLayer(in_channels, mid_channels, num_blocks, MaskChannelwise(reverse_mask=True))))
            else:
