...
class ResNet(Backbone):
    ...
    def forward(self, x, label=None, domain_btcsize=None, use_fmix=True, cam=None):
        ...
        return v.view(v.size(0), -1), fmix, sig.squeeze()
...
def resnet18_fmix_cam_dist_net(pretrained=True, **kwargs):
...
@BACKBONE_REGISTRY.register()
def resnet34_fmix_cam_dist_net(pretrained=True, **kwargs):
...
@BACKBONE_REGISTRY.register()
def resnet50_fmix_cam_dist_net(pretrained=True, **kwargs):
...
@BACKBONE_REGISTRY.register()
def resnet101_fmix_cam_dist_net(pretrained=True, **kwargs):
...
@BACKBONE_REGISTRY.register()
def resnet152_fmix_cam_dist_net(pretrained=True, **kwargs):
