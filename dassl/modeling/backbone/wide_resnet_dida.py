...
from .dmc_layer import DIDAModule
...
class DIDABlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, dropRate=0.0, shortcut=False):
        super().__init__()
...
class WideResNetDIDA(Backbone):
    ...
    def __init__(self, depth, widen_factor, dropRate=0.0):
        ...
        # DIDA block
        self.block3_dida = NetworkBlock(
            n, nChannels[2], nChannels[3], DIDABlock, 2, dropRate
        )
...
def wide_resnet_28_2_dida(**kwargs):
    return WideResNetDIDA(28, 2)
