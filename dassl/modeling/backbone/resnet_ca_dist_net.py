...
def resnet18_ca_dist_net(pretrained=True, **kwargs):
...
@BACKBONE_REGISTRY.register()
def resnet34_ca_dist_net(pretrained=True, **kwargs):
...
@BACKBONE_REGISTRY.register()
def resnet50_ca_dist_net(pretrained=True, **kwargs):
...
@BACKBONE_REGISTRY.register()
def resnet101_ca_dist_net(pretrained=True, **kwargs):
...
@BACKBONE_REGISTRY.register()
def resnet152_ca_dist_net(pretrained=True, **kwargs):
