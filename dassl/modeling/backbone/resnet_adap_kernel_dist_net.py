...
def resnet18_adapkernel_dist_net(pretrained=True, **kwargs):
...
@BACKBONE_REGISTRY.register()
def resnet34_adapkernel_dist_net(pretrained=True, **kwargs):
...
@BACKBONE_REGISTRY.register()
def resnet50_adapkernel_dist_net(pretrained=True, **kwargs):
...
@BACKBONE_REGISTRY.register()
def resnet101_adapkernel_dist_net(pretrained=True, **kwargs):
...
@BACKBONE_REGISTRY.register()
def resnet152_adapkernel_dist_net(pretrained=True, **kwargs):
